...
export class TfDoubleSlider extends TfBase {
      ...
      if (thumbOne && thumbTwo && sliderTrack) {
        switch (newValue) {
          case 'default':
            ...
            sliderTrack.style.setProperty('--tf-track-fill-color', 'var(--tf-sys-light-secondary-container)');
            break;
          case 'focus':
          ...
          case 'disabled':
            ...
            thumbOne.style.setProperty('--tf-track-fill-color', 'var(--tf-sys-light-surface-variant');
            thumbTwo.style.setProperty('--tf-track-fill-color', 'var(--tf-sys-light-surface-variant');
          ...
          case 'error':
            ...
            thumbOne.style.setProperty('--tf-track-fill-color', 'var(--tf-sys-light-error-container)');
            thumbTwo.style.setProperty('--tf-track-fill-color', 'var(--tf-sys-light-error-container)');
  ...
  private fillColor() {
    ...
    const percent2 = (parseInt(this.sliderTwo.value) / this.sliderMaxValue) * 100;
      ...
      const thumbsInteracted = this.sliderOne.matches(':hover') || this.sliderOne.matches(':active') ||
      this.sliderTwo.matches(':hover') || this.sliderTwo.matches(':active');
