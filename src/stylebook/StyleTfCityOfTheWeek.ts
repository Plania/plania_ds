...
const meta: StyleComponentProps<'tf-city-of-the-week'> = {
  ...
  tag: 'tf-city-of-the-week',
  description: 'Plania city of the week component. It is used to showcase a city',
  component: 'Plania City of the Week',
  variants: [tfCityOfTheWeek],
};

export const styleTfCityOfTheWeek = (styleBook: StyleBook) => styleBook.addComponent(meta);
