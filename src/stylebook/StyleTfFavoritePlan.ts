...
const meta: StyleComponentProps<'tf-favorite-plan'> = {
  ...
  tag: 'tf-favorite-plan',
  description: 'Plania favorite plan component. It is used to showcase a favorite plan',
  component: 'Plania Favorite Plan',
  variants: [TfFavoritePlans],
};

export const styleTfFavoritePlan = (styleBook: StyleBook) => styleBook.addComponent(meta);
